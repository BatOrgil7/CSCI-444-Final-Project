...
---
title: "Final Project - Software Engineer Salary Section"
...
# Software engineer salary section - Bat-Orgil Erdenebat
...
In this project the salary data was scraped from O*NET and stored as `data/software_salaries_html_tables.csv`. In this section I read that data, clean the salary columns, and create a statewide summary that will be reused in all visualizations.
...
# Question context: Prepare a clean statewide salary table that is used in Q1, Q2, and Q3.
...
In this question I study how much of the overall median salary is accounted for by the top states. I create a four pipe dplyr pipeline that ranks states by median salary and computes each state s share and cumulative share of the total.
